...
public class ImageView_Preferences {
	...
	public Color getBackgroundColor() {
		...
		// com.google.gson.internal.LinkedTreeMap cannot be cast to javafx.graphics@10.0.1/com.sun.prism.paint.Paint
		// return backgroundColor;

		return new Color(backgroundColor.getRed(), backgroundColor.getGreen(), backgroundColor.getBlue(), backgroundColor.getOpacity());
	}
